...
Muscat, Oman</a>
        <!-- Reach Us column social (disabled)
 <div class="f-footer-social">
    ...
    <div class="f-footer-bottom">
      ...
      <p style="color:var(--orange);font-size:1rem;font-weight:600;">Customer service and Inquiries: <a href="tel:+96890643963" style="color:inherit;">+968 9064 3963</a></p>
     
      <div class="f-footer-social">
        <a href="https://www.instagram.com/farjar.om?igsh=YWgxenp6aTJ0emhy" aria-label="Instagram"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg></a>
        <a href="https://www.linkedin.com/company/farjar-construction-development-llc/" aria-label="LinkedIn"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-4 0v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg></a>
